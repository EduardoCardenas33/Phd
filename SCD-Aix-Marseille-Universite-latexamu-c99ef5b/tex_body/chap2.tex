...
\begin{figure*}[htbp]
    \centering
    \subfloat[]{%
        \includesvg[width=\figwidth,height=\figheight]{InternalEnergyVSTemp(1)}%
        \label{fig:subfig1}%
    }\hfill
    \subfloat[]{%
        \includesvg[width=\figwidth,height=\figheight]{SoundSpeedVSTemp(1)}%
        \label{fig:subfig2}%
    }\hfill
    \subfloat[]{%
        \includesvg[width=\figwidth,height=\figheight]{CpVSTemp(1)}%
        \label{fig:subfig3}%
    }\hfill
    \subfloat[]{%
        \includesvg[width=\figwidth,height=\figheight]{ZVSTemp(1)}%
        \label{fig:subfig4}%
    }\hfill
    \subfloat[]{%
        \includesvg[width=\figwidth,height=\figheight]{RhoVSTemp(1)}%
        \label{fig:subfig5}%
    }\hfill
    \subfloat[]{%
        \includesvg[width=\figwidth,height=\figheight]{betaVSTemp(1)}%
        \label{fig:subfig6}%
    }
    \caption{
